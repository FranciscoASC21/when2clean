...
const parks = [["Prospect Park", "Walk Whitman Park", "Marine Park", "Fort Greene Park", "Canarsie Park", "Sunset Park", "Kaiser Park"], ["Crotona Park", "Franz Sigel Park", "Ferry Point Park", "Mullaly Park", "Soundview Park", "Mill Pond Park"], ["Central Park", "Washington Square Park", "Battery Park", "Bryant Park", "Isham Park"], ["Kissena Park", "Forest Park", "Elmhust Park", "Travers Park", "Astoria Park", "Bowne Park"], ["High Rock Park", "Silver Lake Park", "Brookfield Park", "Ocean Breeze Park", "Tappen Park", "Willowbrook Park"]];
